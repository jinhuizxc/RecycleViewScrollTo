package com.jinhui.recycleviewscrollto;
...
/**
 * 横向RecycleView实现手势监听、
 * 左右两个按钮改变RecycleView滑动距离，监听控制其滑动功能
 */
    ...
    private void initView() {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (firstVisible <= 0) {
                    Toast.makeText(MainActivity.this, "position = " + firstVisible, Toast.LENGTH_SHORT).show();
                    back.setImageResource(R.drawable.left_gray);
                    enter.setImageResource(R.drawable.goenter);
                } else if (lastVisible >= mAdapter.getItemCount() - 1) {
                    Toast.makeText(MainActivity.this, "position 1= " + lastVisible, Toast.LENGTH_SHORT).show();
                    back.setImageResource(R.drawable.back);
                    enter.setImageResource(R.drawable.right_gray);
                } else {
                    Toast.makeText(MainActivity.this, "position 2= " + firstVisible + lastVisible, Toast.LENGTH_SHORT).show();
                    back.setImageResource(R.drawable.back);
                    enter.setImageResource(R.drawable.goenter);
                }
            }
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dx > 0) {
                    Log.e("test", "onScrolled 向右");
                    //大于0表示正在向右滚动
                    isSlidingToLast = true;
                } else {
                    Log.e("test", "onScrolled 向左");
                    //小于等于0表示停止或向左滚动
